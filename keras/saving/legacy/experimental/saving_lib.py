...
from keras.saving.legacy.experimental.serialization_lib import deserialize_keras_object
from keras.saving.legacy.experimental.serialization_lib import serialize_keras_object
