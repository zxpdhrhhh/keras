...
def warmstart_embedding_matrix(
    ...
    verify that the embeddings corresponding to "a" match in base and new
    embeddings
    >>> tf.print(warmstarted_embedding_matrix[2], vectorized_vocab_base[1])
    ...
    Args:
        base_vocabulary: The list of vocabulary terms that
          ...
          terms (strings), or a path to a vocabulary text file. If passing a
           file path, the file should contain one line per term in the vocabulary.
